...
import userStyles from './usage.module.css';
...
const internalReducer = ({ count, countTotal }, action) => {
    switch (action.type) {
        case 'clap':
            return {
                isClicked: true,
...
const StateReducerPattern = () => {
    ...
    const { clapState, getTogglerProps, getCounterProps, reset, resetDep } = useClapState(
        userInitialState,
        reducer
    );
